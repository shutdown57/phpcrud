...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $db = new Database();
    $data = $db->toArray($_POST["email"], $_POST["title"], $_POST["content"]);
    if ($data) {
        $db->insertPost($data);
    }
}
...
<body>
    ...
    <div class="container content">
        <form id="add-form" method="POST" action="<?php print htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <div class="columns">
                <div class="column">
                    <div class="field">
            ...
            <div>
                <button id="btn-add" class="button is-primary" type="submit">Add</button>
            </div>
        </form>
    </div>
    </section>
